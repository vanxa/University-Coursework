...
export LoadConfig_meshcomm
export _LoadConfig_meshcomm
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_meshcomm
	lcall	LoadConfigTBL_meshcomm_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration meshcomm
;
;    Load configuration registers for meshcomm.
...
_LoadConfig_meshcomm:
 LoadConfig_meshcomm:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_meshcomm_Bank0
    mov     X, <LoadConfigTBL_meshcomm_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_meshcomm_Bank1
    mov     X, <LoadConfigTBL_meshcomm_Bank1
