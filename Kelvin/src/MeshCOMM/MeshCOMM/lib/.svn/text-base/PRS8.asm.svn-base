...
export   PRS8_Stop
export  _PRS8_Stop
export   PRS8_WriteSeed
export  _PRS8_WriteSeed
export   PRS8_WritePolynomial
export  _PRS8_WritePolynomial
export   PRS8_bReadPRS
export  _PRS8_bReadPRS
...
; for new designs.
export  bPRS8_ReadPRS
export _bPRS8_ReadPRS
;--------------------------------------------
...
_PRS8_Start:
   ...
   or    REG[PRS8_CONTROL_REG], bfCONTROL_REG_START_BIT
...
_PRS8_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[PRS8_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_PRS8_WriteSeed:
   ...
   pop   A
   mov   reg[PRS8_SEED_REG], A

   ; restore the start state
   mov   A, X
   mov   REG[PRS8_CONTROL_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PRS8_WritePolynomial
;
;  DESCRIPTION:
...
;
 PRS8_bReadPRS:
_PRS8_bReadPRS:
 bPRS8_ReadPRS:    ; For backwards compatibility, do not use!
_bPRS8_ReadPRS:    ; For backwards compatibility, do not use!

   RAM_PROLOGUE RAM_USE_CLASS_1
   ; Read the Shift register.  This causes the current
   ;  PRS computed number to be transferred to the Seed register.
   mov   A, reg[PRS8_SHIFT_REG]

   ; Read the PRS computed value
   mov   A, reg[PRS8_SEED_REG]

   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION

; End of File PRS8.asm
