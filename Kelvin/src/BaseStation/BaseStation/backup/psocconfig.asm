...
export LoadConfig_basestation
export _LoadConfig_basestation
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_basestation
	lcall	LoadConfigTBL_basestation_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration basestation
;
;    Load configuration registers for basestation.
...
;               CUR_PP
;
_LoadConfig_basestation:
 LoadConfig_basestation:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_basestation_Bank0
    mov     X, <LoadConfigTBL_basestation_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_basestation_Bank1
    mov     X, <LoadConfigTBL_basestation_Bank1
