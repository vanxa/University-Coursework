...
;  the underscore.
;-------------------------------------------------------------------
export  serial_uart_SetTxIntMode
export _serial_uart_SetTxIntMode
export  serial_uart_EnableInt
export _serial_uart_EnableInt
export  serial_uart_DisableInt
export _serial_uart_DisableInt

export  serial_uart_Start
export _serial_uart_Start
export  serial_uart_Stop
export _serial_uart_Stop
export  serial_uart_SendData
export _serial_uart_SendData
export  serial_uart_bReadTxStatus
export _serial_uart_bReadTxStatus
export  serial_uart_bReadRxData
export _serial_uart_bReadRxData
export  serial_uart_bReadRxStatus
export _serial_uart_bReadRxStatus

export  serial_uart_IntCntl
export _serial_uart_IntCntl

export  serial_uart_TxIntMode
export _serial_uart_TxIntMode

export  serial_uart_PutSHexByte
export _serial_uart_PutSHexByte
export  serial_uart_PutSHexInt
export _serial_uart_PutSHexInt

export  serial_uart_CPutString
export _serial_uart_CPutString
export  serial_uart_PutString
export _serial_uart_PutString
export  serial_uart_PutChar
export _serial_uart_PutChar
export  serial_uart_Write
export _serial_uart_Write
export  serial_uart_CWrite
export _serial_uart_CWrite

export  serial_uart_cGetChar
export _serial_uart_cGetChar
export  serial_uart_cReadChar
export _serial_uart_cReadChar
export  serial_uart_iReadChar
export _serial_uart_iReadChar
export  serial_uart_PutCRLF
export _serial_uart_PutCRLF

IF (serial_uart_RXBUF_ENABLE)
export  serial_uart_CmdReset
export _serial_uart_CmdReset
export  serial_uart_bCmdCheck
export _serial_uart_bCmdCheck
export  serial_uart_bCmdLength
export _serial_uart_bCmdLength
export  serial_uart_bErrCheck
export _serial_uart_bErrCheck

export  serial_uart_szGetParam
export _serial_uart_szGetParam
export  serial_uart_szGetRestOfParams
export _serial_uart_szGetRestOfParams
ENDIF
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
export  bserial_uart_ReadTxStatus
export _bserial_uart_ReadTxStatus
export  bserial_uart_ReadRxData
export _bserial_uart_ReadRxData
export  bserial_uart_ReadRxStatus
export _bserial_uart_ReadRxStatus
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 serial_uart_EnableInt:
_serial_uart_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_EnableIntMask serial_uart_TX_INT_REG, serial_uart_TX_INT_MASK
   M8C_EnableIntMask serial_uart_RX_INT_REG, serial_uart_RX_INT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 serial_uart_DisableInt:
_serial_uart_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask serial_uart_TX_INT_REG, serial_uart_TX_INT_MASK
   M8C_DisableIntMask serial_uart_RX_INT_REG, serial_uart_RX_INT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
;
 serial_uart_SetTxIntMode:
_serial_uart_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, serial_uart_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[serial_uart_TX_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[serial_uart_TX_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_serial_uart_Start:
   ...
   mov   REG[serial_uart_TX_CONTROL_REG], A
   mov   REG[serial_uart_RX_CONTROL_REG], A
IF ( serial_uart_RXBUF_ENABLE )
   call  _serial_uart_CmdReset
ENDIF
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_Stop
;
;  DESCRIPTION:
...
_serial_uart_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[serial_uart_TX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   and   REG[serial_uart_RX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_SendData
;
;  DESCRIPTION:
...
;    functions.
;
 serial_uart_SendData:
_serial_uart_SendData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov REG[serial_uart_TX_BUFFER_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_bReadTxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 serial_uart_bReadTxStatus:
_serial_uart_bReadTxStatus:
 bserial_uart_ReadTxStatus:                      ; For backwards compatibility only
_bserial_uart_ReadTxStatus:                      ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[serial_uart_TX_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_bReadRxData
;
;  DESCRIPTION:
...
;    functions.
;
 serial_uart_bReadRxData:
_serial_uart_bReadRxData:
 bserial_uart_ReadRxData:                        ; For backwards compatibility only
_bserial_uart_ReadRxData:                        ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[serial_uart_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 serial_uart_bReadRxStatus:
_serial_uart_bReadRxStatus:
 bserial_uart_ReadRxStatus:                      ; For backwards compatibility only
_bserial_uart_ReadRxStatus:                      ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[serial_uart_RX_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_TxIntMode
;
;  DESCRIPTION:
...
;    functions.
;
 serial_uart_TxIntMode:
_serial_uart_TxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1

   and  A,serial_uart_INT_MODE_TX_COMPLETE
   M8C_SetBank1
   cmp  A,serial_uart_INT_MODE_TX_COMPLETE
   jz   .SetTxCmpMode

   and  reg[serial_uart_TX_FUNC_REG],0xEF        ; Set Interrupt on Tx_Reg_Empty
   jmp  .TxIntMode_End

.SetTxCmpMode:                                       ; Set Interrupt on TX Complete
   or   reg[serial_uart_TX_FUNC_REG],0x10
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_IntCntl
;
;  DESCRIPTION:
...
;
 serial_uart_IntCntl:
_serial_uart_IntCntl:
   RAM_PROLOGUE RAM_USE_CLASS_1

   push A
   and  A,serial_uart_ENABLE_RX_INT
   jz   .DisRxInt
     ; Enable Rx Interrupt
   M8C_EnableIntMask serial_uart_RX_INT_REG, serial_uart_RX_INT_MASK
   jmp  .CheckTxInt
...
.CheckTxInt:
   pop  A
   and  A,serial_uart_ENABLE_TX_INT
   jz   .DisTxInt
     ; Enable Tx Interrupt
   M8C_EnableIntMask serial_uart_TX_INT_REG, serial_uart_TX_INT_MASK
   jmp  .End_IntCntl
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_PutSHexByte
;
;  DESCRIPTION:
...
.SECTION
 serial_uart_PutSHexByte:
_serial_uart_PutSHexByte:
   RAM_PROLOGUE RAM_USE_CLASS_1
   ...
   index serial_uart_HEX_STR           ; Get Hex value
   call  serial_uart_PutChar           ; Write data to screen
   pop   A                             ; Restore value
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_PutSHexInt
;
;  DESCRIPTION:
...
;
 ...
 serial_uart_PutSHexInt:
_serial_uart_PutSHexInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   swap  A,X
   call  serial_uart_PutSHexByte       ; Print MSB
   mov   A,X                           ; Move LSB into position
   call  serial_uart_PutSHexByte       ; Print LSB
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_PutChar
;
;  DESCRIPTION:
...
.BufEmptyWaitLoop:
   tst REG[serial_uart_TX_CONTROL_REG], serial_uart_TX_BUFFER_EMPTY     ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[serial_uart_TX_BUFFER_REG], @Source     ; Write data to Tx Port
   endm

 serial_uart_PutChar:
_serial_uart_PutChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   InLinePutChar A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_cGetChar
;
;  DESCRIPTION:
...
;
 serial_uart_cGetChar:
_serial_uart_cGetChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   tst REG[serial_uart_RX_CONTROL_REG],serial_uart_RX_REG_FULL    ; Check if a character is ready
   jz  serial_uart_cGetChar                              ; If not loop
   mov A, REG[serial_uart_RX_BUFFER_REG]                 ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;-----------------------------------------------------------------------------
...
;
 serial_uart_cReadChar:
_serial_uart_cReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov  A,REG[serial_uart_RX_CONTROL_REG]                  ; Get Status of RX
   push A
   and  A,serial_uart_RX_COMPLETE                          ; Check if a character is ready
...
.RX_DATA_RDY:
   ...
   and  A,(serial_uart_RX_PARITY_ERROR | serial_uart_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_iReadChar
;
...
;    functions.
;
 serial_uart_iReadChar:
_serial_uart_iReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov  A,REG[serial_uart_RX_CONTROL_REG]                  ; Get Status of RX
                                                           ; Mask only errors and data ready
   and  A,(serial_uart_RX_ERROR|serial_uart_RX_REG_FULL)
   push A
   and  A,serial_uart_RX_COMPLETE                          ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,serial_uart_RX_NO_DATA                           ; Add no data flag
   swap A,X
   jmp  End_serial_uart_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,serial_uart_RX_ERROR
   swap A,X
   mov  A,REG[serial_uart_RX_BUFFER_REG ]                  ; Read data first, then
                                                           ; determine if data is valid

 End_serial_uart_iReadChar:
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_PutString
;
;  DESCRIPTION:
...
;          IDX_PP
;
 serial_uart_PutString:
_serial_uart_PutString:
   RAM_PROLOGUE RAM_USE_CLASS_3
   RAM_SETPAGE_IDX A
.PutStringLoop:
   mov   A,[X]                                   ; Get value pointed to by X
   jz    End_PutString                           ; Check for end of string
   call  serial_uart_PutChar                     ; Send character to Tx port
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_Write
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_CWrite
;
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_CPutString
;
;  DESCRIPTION:
;     Send String out through UART TX port.
;-----------------------------------------------------------------------------
...
;    functions.
;
 serial_uart_CPutString:
_serial_uart_CPutString:
   RAM_PROLOGUE RAM_USE_CLASS_1
   push  A                                       ; Store ROM pointer
   push  X
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  serial_uart_PutChar                     ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   serial_uart_CPutString                  ; Check for carry
   inc   A                                       ; Inc MSB of pointer
   jmp   serial_uart_CPutString
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_PutCRLF
;
;  DESCRIPTION:
;     Send a CR and LF
;-----------------------------------------------------------------------------
...
;
 serial_uart_PutCRLF:
_serial_uart_PutCRLF:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov  A,0x0D                        ; Send CR
   call serial_uart_PutChar
   mov  A,0x0A                        ; Send LF
   call serial_uart_PutChar
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_CmdReset
;
;  DESCRIPTION:
...
;
 serial_uart_CmdReset:
_serial_uart_CmdReset:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >serial_uart_aRxBuffer
   mov [serial_uart_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >serial_uart_bRxCnt
   mov [serial_uart_bRxCnt], 0x00
   and [serial_uart_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_bCmdCheck
;
;  DESCRIPTION:
...
;
 serial_uart_bCmdCheck:
_serial_uart_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >serial_uart_fStatus
   mov A,  [serial_uart_fStatus]
   and A, serial_uart_RX_BUF_CMDTERM             ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_bErrCheck
;
;  DESCRIPTION:
...
;
 serial_uart_bErrCheck:
_serial_uart_bErrCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >serial_uart_fStatus
   mov A,  [serial_uart_fStatus]
   and A, serial_uart_RX_BUF_ERROR               ; Mask off Error status
   and [serial_uart_fStatus], ~serial_uart_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_bCmdLength
;
;  DESCRIPTION:
...
;          CUR_PP
;
 serial_uart_bCmdLength:
_serial_uart_bCmdLength:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >serial_uart_bRxCnt
   mov A,  [serial_uart_bRxCnt]
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_szGetParam
;
;  DESCRIPTION:
;      Return next parameter from serial_uart Rx buffer
;-----------------------------------------------------------------------------
;
;  ARGUMENTS:  none
;
...
;     serial_uart_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, serial_uart_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See serial_uart_bCmdCheck).
;
...
;
 serial_uart_szGetParam:
_serial_uart_szGetParam:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_PROLOGUE RAM_USE_CLASS_3
    
   RAM_SETPAGE_CUR >ptrParam
   mov   A, <serial_uart_aRxBuffer          ; Get address to receive buffer
...
.ParamLoop:                                 ; Now loop until end of parameter found.
   ...
   inc   [ptrParam]
   cmp   [ptrParam], (serial_uart_RX_BUFFER_SIZE -1)   ; Check if we are at the end of buffer
   jz    .TerminateString
   mov   A, [X]                             ; Get next character
   jz    .End_GetNextParam
   cmp   A, serial_uart_DELIMITER           ; Check if we have a delimiter
   ...
   mov   [ptrParam], (serial_uart_RX_BUFFER_SIZE -1)   ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A, >serial_uart_aRxBuffer           ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: serial_uart_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 serial_uart_szGetRestOfParams:
_serial_uart_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
   mov  A, <serial_uart_aRxBuffer           ; Get address to receive buffer
   add  A, [ptrParam]                       ; Add string offset
