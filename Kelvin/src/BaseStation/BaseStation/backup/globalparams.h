...
#define PORT_0_DRIVE_0         0x61    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0x9e    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0x9c    //Port 0 drive mode 1 register (PRT0DM2)
...
#define PORT_1_DRIVE_0         0x8     //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0xff    //Port 1 drive mode 1 register (PRT1DM1)
#define PORT_1_DRIVE_2         0xf4    //Port 1 drive mode 2 register (PRT1DM2)
...
#define PORT_2_DRIVE_0         0x5b    //Port 2 drive mode 0 register (PRT2DM0)
#define PORT_2_DRIVE_1         0xa4    //Port 2 drive mode 1 register (PRT2DM1)
...
#define PORT_3_GLOBAL_SELECT   0x15    //Port 3 global select register (PRT3GS)
#define PORT_3_DRIVE_0         0x5     //Port 3 drive mode 0 register (PRT3DM0)
#define PORT_3_DRIVE_1         0xfa    //Port 3 drive mode 1 register (PRT3DM1)
#define PORT_3_DRIVE_2         0x40    //Port 3 drive mode 2 register (PRT3DM2)
#define PORT_3_INTENABLE       0x80    //Port 3 interrupt enable register (PRT3IE)
#define PORT_3_INTCTRL_0       0x0     //Port 3 interrupt control 0 register (PRT3IC0)
#define PORT_3_INTCTRL_1       0x80    //Port 3 interrupt control 1 register (PRT3IC1)
#define PORT_4_GLOBAL_SELECT   0x0     //Port 4 global select register (PRT4GS)
#define PORT_4_DRIVE_0         0x2     //Port 4 drive mode 0 register (PRT4DM0)
#define PORT_4_DRIVE_1         0xff    //Port 4 drive mode 1 register (PRT4DM1)
#define PORT_4_DRIVE_2         0xfd    //Port 4 drive mode 2 register (PRT4DM2)
...
#define PORT_5_DRIVE_0         0x7     //Port 5 drive mode 0 register (PRT5DM0)
...
#define PORT_5_INTENABLE       0x8     //Port 5 interrupt enable register (PRT5IE)
#define PORT_5_INTCTRL_0       0x0     //Port 5 interrupt control 0 register (PRT5IC0)
#define PORT_5_INTCTRL_1       0x8     //Port 5 interrupt control 1 register (PRT5IC1)
