...
;  Global Symbols
;-----------------------------------------------
export  pga_adc_in_2_Start
export _pga_adc_in_2_Start
export  pga_adc_in_2_SetPower
export _pga_adc_in_2_SetPower

export  pga_adc_in_2_SetGain
export _pga_adc_in_2_SetGain

export  pga_adc_in_2_Stop
export _pga_adc_in_2_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: pga_adc_in_2_Start
;  FUNCTION NAME: pga_adc_in_2_SetPower
;
;  DESCRIPTION:
...
;
 pga_adc_in_2_Start:
_pga_adc_in_2_Start:
 pga_adc_in_2_SetPower:
_pga_adc_in_2_SetPower:
...
;
   ...
   mov  A, reg[pga_adc_in_2_GAIN_CR2]                      ; read power value
   and  A, ~POWERMASK                                ; clear power bits in A
   or   A, [X]                                       ; combine power value with balance of reg.
   mov  reg[pga_adc_in_2_GAIN_CR2], A                 ; move complete value back to register
   pop  A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: pga_adc_in_2_SetGain
;
;  DESCRIPTION:
...
;    functions.
;
 pga_adc_in_2_SetGain:
_pga_adc_in_2_SetGain:
...
;
   ...
   mov  A, reg[pga_adc_in_2_GAIN_CR0]                      ; read mux settings
   and  A, ~GAINREGMASK                                   ; clear gain bits in A
   tst  [X],HIGHGAIN                                      ; See if High Gain is set
   jnz  .SETHIGHGAIN
   and  reg[pga_adc_in_2_GAIN_CR3],~EXGAIN                 ; Clear High Gain bit.
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[pga_adc_in_2_GAIN_CR0], A                      ; move complete value back to register
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
...
.SETHIGHGAIN:
   ...
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[pga_adc_in_2_GAIN_CR0], A                      ; move complete value back to register
   or   reg[pga_adc_in_2_GAIN_CR3], EXGAIN                 ; Set High Gain bit.
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: pga_adc_in_2_Stop
;
;  DESCRIPTION:
...
_pga_adc_in_2_Stop:
   ...
   and REG[pga_adc_in_2_GAIN_CR2], ~POWERMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
; End of File pga_adc_in_2.asm
